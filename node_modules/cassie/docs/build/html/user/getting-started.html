...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>2. Getting Started &mdash; Cassie v1.3.1 documentation</title>
...
<span id="index-0"></span><h1>2. Getting Started<a class="headerlink" href="#getting-started" title="Permalink to this headline">¶</a></h1>
</div>
...
<script type="text/javascript">$('#searchbox').show(0);</script>
 ...
 <div id="footer">
   <ul class="panel-links">
     ...
     <li>
       <a href="../_sources/user/getting-started.txt"
