...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Learning Cassie &mdash; Cassie v1.3.1 documentation</title>
    ...
    <link rel="prev" title="Cassie —at a glance—" href="../index.html" /> 
  </head>
  <body>
   <div id="header">
  ...
  <div class="section" id="learning-cassie">
<h1>Learning Cassie<a class="headerlink" href="#learning-cassie" title="Permalink to this headline">¶</a></h1>
<p>This guide will walk you through the basic concepts in Cassie, and how it can
make your asynchronous code more structured. Along the way, and through the
examples, you&#8217;ll learn about <a class="reference external" href="http://en.wikipedia.org/wiki/Futures_and_promises">Deferreds</a>, <a class="reference external" href="http://en.wikipedia.org/wiki/Futures_and_promises">Promises</a>, how to manage multiple
dependencies, etc. Stick with me!</p>
<div class="section" id="table-of-contents">
<h2>Table of Contents<a class="headerlink" href="#table-of-contents" title="Permalink to this headline">¶</a></h2>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="overview.html">1. Overview</a><ul>
<li class="toctree-l2"><a class="reference internal" href="overview.html#why-use-it">1.1. Why use it?</a></li>
<li class="toctree-l2"><a class="reference internal" href="overview.html#cool-how-do-i-use-it">1.2. Cool! How do I use it?</a></li>
</ul>
</li>
...
<div id="toc">
  <ul>
<li><a class="reference internal" href="#">Learning Cassie</a><ul>
