    ...
    if (prediction === 'Question') {
      const handleGetRecommendations = async () => {
        try {
          ...
          const keywordsPrompt = `Based on the following question, '${query}', and answer, '${recommendation}', give me up to 3 comma separated keywords that can help me find informative and actionable videos on a short form social media app. The keywords should be directly related to the specific content and themes mentioned in both the question and the answer.`;
